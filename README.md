...
[![R-CMD-check](https://github.com/ATRC-AURIN/RCITI_PopulationSynthesiser/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/AURIN-OFFICE/RCITI_PopulationSynthesiser/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
