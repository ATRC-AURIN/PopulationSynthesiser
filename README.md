...
[![R-CMD-check](https://github.com/AURIN-OFFICE/RCITI_PopulationSynthesiser/workflows/R-CMD-check/badge.svg)](https://github.com/AURIN-OFFICE/RCITI_PopulationSynthesiser/actions)
<!-- badges: end -->
